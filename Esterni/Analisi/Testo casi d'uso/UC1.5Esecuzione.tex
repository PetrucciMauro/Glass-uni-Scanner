\subsection{UC 1.5 - Esecuzione presentazione}{
	...
	\textbf{Precondizione}: la presentazione scelta dall'utente è già stata caricata dal sistema.	\\
	\textbf{Postcondizione}: l'utente può scegliere il metodo di avanzamento dei frame che ritiene più appropriato.	\\
	\textbf{Procedura principale}:
	\begin{enumerate}
		\item scelta del metodo con cui eseguire la presentazione: automatica o manuale
...
\subsection{UC 1.5.1 - Esecuzione manuale}{
	...
	\subsection{UC 1.5.1.1 - Scorrimento avanti e indietro dei frame}{
		\label{uc1.5.1.1}
		\textbf{Attori}: utente generico \\
