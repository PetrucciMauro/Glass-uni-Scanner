...
\end{itemize}
   ...
   \end{itemize}
	...
	fatta tramite il servizio W3C\ped{g} Validator32 del W3C\ped{g}.
		...
		L'attività di validazione consiste nei seguenti task:
		\begin{itemize}
		\item Preparare i test dei singoli requisiti e la specifica dei test per l'analisi dei risultati;
		\item Assicurari che i requisiti testati riflettano uno specifico uso dell'applicazione;
		\item Condurre i test include include:
		\begin{itemize}
		...
		\end{itemize}
		\item Validare che il software soddisfi gli scopi per cui è stato creato.
		\end{itemize}		
