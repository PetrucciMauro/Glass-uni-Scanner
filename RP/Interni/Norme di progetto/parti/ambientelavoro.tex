...
Il software\ped{g} per il controllo ortografico è \textbf{Aspell}\ .\ Il programma\ped{g} è accessibile tramite il \emph{Makefile}.
...
\subsubsection{Ticket\ped{g} di pianificazione}
...
\subsubsection{Ticket\ped{g} di realizzazione e controllo} 
...
\subsubsection{Ticket\ped{g} di verifica}
