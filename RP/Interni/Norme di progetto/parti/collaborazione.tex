...
\Tree[.documents [.Esterni \textit{Analisi dei requisiti} \textit{Glossario} \textit{Piano di progetto} \textit{Piano di qualifica} \textit{Specifica tecnica} ]
                 [.Interni \textit{Norme di progetto} \textit{Verbali} ]
                 [.Template ]]
\end{tikzpicture}
