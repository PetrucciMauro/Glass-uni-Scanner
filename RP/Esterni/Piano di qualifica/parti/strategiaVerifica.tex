...
\section{Risorse}{
\subsection{Risorse\ped{g} necessarie:}{
	\subsubsection{Risorse\ped{g} umane}{
	...
	\subsubsection{Risorse\ped{g} Hardware}{
		Saranno necessari:
		\begin{itemize}
	...
	\subsubsection{Risorse\ped{g} software}{
		Saranno necessari:
		\begin{itemize}
...
\subsection{Risorse\ped{g} disponibili}{
	Sono disponibili:
	\begin{itemize}
