...
comportamento dinamico del sistema completo rispetto ai Requisiti\ped{g} descritti nell’ \href{run:../../Esterni/\fAnalisiDeiRequisiti}{\fEscapeAnalisiDeiRequisiti}.
	...
	meritevoli di un test.
		...
		\begin{longtable} [c]{| p{3cm} | p{6cm} |p{3cm}|}
			...
			\hline
			TS 7.7.25 & Verificare che si possa inserire un Elemento\ped{g} scelta in un Frame\ped{g} & RF 7.7.25\\
			\hline
			TS 7.7.28 & Viene verificato che si possa modificare un Elemento\ped{g} scelta & RF 7.7.28\\
			\hline
			...
			\hline
			TS 61.1.4 & Viene verificato che si possa selezionare un Elemento\ped{g} scelta se presente nel Frame\ped{g} & RF 61.1.4\\
			\hline
