\subsection{UC 0.9 - Gestione template}{
	...
	\begin{enumerate}
		\item Caricamento di un template di infografica o di presentazione \hyperref[uc0.9.1]{(UC0.9.1)};
		\item Caricamento di un elemento \hyperref[uc0.9.3]{(UC0.9.3)};
		\item Eliminazione di un template \hyperref[uc0.9.5]{(UC0.9.5)};
	\end{enumerate}
	\textbf{Scenari alternativi}:
	\begin{itemize}
		\item L'amministratore può ripristinare un template eliminato \hyperref[uc0.9.5]{(UC0.9.5)};
