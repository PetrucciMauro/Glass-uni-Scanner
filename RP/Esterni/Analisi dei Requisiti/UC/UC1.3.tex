\subsection{UC 1.3 - Modifica presentazione da desktop}{
	...
	\begin{enumerate}
		...
		\item L'utente può eliminare un elemento \S\hyperref[uc1.3.12]{(UC 1.3.12)};
		\item L'utente può modificare la rotazione di un elemento \S\hyperref[uc1.3.13]{(UC 1.3.13)};
	\end{enumerate}
...
\subsubsection{UC 1.3.3 - Modifica desktop di un frame}{
	...
	\begin{enumerate}
		...
		\item Modifica rotazione di un frame \S\hyperref[uc1.3.3.8]{(UC 1.3.3.8)};
...
\subsubsection{UC 1.3.3.8 - Modifica rotazione di un frame}{
	...
	\textbf{Scenario principale}:
	\begin{enumerate}
		\item L'utente destop seleziona un frame;
