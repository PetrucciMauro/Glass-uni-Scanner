...
\subsubsection{UC 1.3.3 - Modifica desktop di un frame}{
	...
	\textbf{Precondizione}: il sistema ha caricato correttamente una presentazione la quale è pronta per essere modificata.	\\
...
\subsubsection{UC 1.3.3.12 - Modifica della forma di un frame}{
	\label{uc1.3.3.12}
	\textbf{Attori}: utente desktop \\
	\textbf{Descrizione}: l'utente desktop modifica la forma del frame. Le forme disponibili sono: cerchio, rettangolo, parentesi quadre o graffe e trasparente. \\
