...
\subsubsection{UC 1.3.8.1 - Selezione transizione}{
	\label{uc1.3..8.1}
	\textbf{Attori}: utente desktop \\
	\textbf{Descrizione}: l'utente vuole selezionare una transizione tra due frame consecutivi in un percorso. \\
	...
	\textbf{Scenario principale}:
	\begin{enumerate}
		\item L'utente seleziona una transizione tra due frame consecutivi.
	\end{enumerate}
}
