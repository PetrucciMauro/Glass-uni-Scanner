\subsection{UC 1.3 - Modifica presentazione da desktop}{
	...
	\begin{enumerate}
		\item L'utente può inserire un nuovo frame vuoto \S\hyperref[uc1.3.1]{(UC 1.3.1)};
		\item L'utente può spostare i frame nel piano della presentazione \S\hyperref[uc1.3.2]{(UC 1.3.2)};
		\item L'utente può modificare i frame inseriti \S\hyperref[uc1.3.3]{(UC 1.3.3)};
		\item L'utente può eliminare i frame inseriti \S\hyperref[uc1.3.4]{(UC 1.3.4)};
		\item L'utente può impostare uno sfondo \S\hyperref[uc1.3.5]{(UC 1.3.5)};
		\item L'utente può definire i percorsi della presentazione \S\hyperref[uc1.3.6]{(UC 1.3.6)};
		\item L'utente può inserire e cancellare bookmark \S\hyperref[uc1.3.7]{(UC 1.3.7)};
		\item L'utente può impostare le opzioni di esecuzione della presentazione \S\hyperref[uc1.3.8]{(UC 1.3.8)};
		\item L'utente può definire i tempi di permanenza sui frame \S\hyperref[uc1.3.9]{(UC 1.3.9)};
		\item L'utente può inserire un elemento SVG \S\hyperref[uc1.3.10]{(UC 1.3.10)};
		\item L'utente può modifica un elemento SVG \S\hyperref[uc1.3.11]{(UC 1.3.11)};
	\end{enumerate}
...
\subsubsection{UC 1.3.1 - Inserimento nuovo frame}{
	...
	\textbf{Scenario principale}:
	\begin{enumerate}
		\item L'utente seleziona un frame nel menu a lato del piano della presentazione \S\hyperref[uc1.3.1.1]{(UC 1.3.1.1)};
		\item L'utente sposta il frame all'interno del piano della presentazione \S\hyperref[uc1.3.1.2]{(UC 1.3.1.2)};
...
\subsubsection{UC 1.3.3 - Modifica desktop di un frame}{
	...
	\textbf{Scenario principale}:
	\begin{enumerate}
		\item Inserimento di un elemento testo \S\hyperref[uc1.3.3.1]{(UC 1.3.3.1)};
		\item Inserimento di un elemento immagine \S\hyperref[uc1.3.3.2]{(UC 1.3.3.2)};
		\item Inserimento di un elemento video \S\hyperref[uc1.3.3.3]{(UC 1.3.3.3)};
		\item Modifica di un elemento testo \S\hyperref[uc1.3.3.4]{(UC 1.3.3.4)};
		\item Modifica di un elemento immagine \S\hyperref[uc1.3.3.5]{(UC 1.3.3.5)};
		\item Modifica di un elemento video \S\hyperref[uc1.3.3.6]{(UC 1.3.3.6)};
		\item Spostamento di un elemento \S\hyperref[uc1.3.3.7]{(UC 1.3.3.7)};
		\item Eliminazione di un elemento \S\hyperref[uc1.3.3.8]{(UC 1.3.3.8)};
		\item Inserimento di un elemento scelta \S\hyperref[uc1.3.3.9]{(UC 1.3.3.9)};
		\item Modifica di un elemento scelta \S\hyperref[uc1.3.3.10]{(UC 1.3.3.10)};
		\item Modifica della dimensione del frame \S\hyperref[uc1.3.3.11]{(UC 1.3.3.11)};
		\item Modifica della forma del frame \S\hyperref[uc1.3.3.12]{(UC 1.3.3.12)};
		\item Modifica dello spessore del bordo del frame \S\hyperref[uc1.3.3.13]{(UC 1.3.3.13)};
		\item Modifica del colore del bordo del frame \S\hyperref[uc1.3.3.14]{(UC 1.3.3.14)};
		\item Modifica dello sfondo del frame \S\hyperref[uc1.3.3.15]{(UC 1.3.3.15)};
	\end{enumerate}
	}
...
\subsubsection{UC 1.3.5 - Impostazione sfondo}{
	...
	\begin{enumerate}
		...
		\item L'utente può spostare l'area di sfondo sul piano della presentazione \S\hyperref[uc1.3.5.2]{(UC 1.3.5.2)};
		\item L'utente può ridimensionare l'area di sfondo sul piano della presentazione \S\hyperref[uc1.3.5.3]{(UC 1.3.5.3)};
...
\subsubsection{UC 1.3.5.1 - Inserimento sfondo}{
	...
	\begin{enumerate}
		...
		\item L'utente definisce un'area nel piano della presentazione per ospitare lo sfondo \S\hyperref[uc1.3.5.1.3]{(UC 1.3.5.3)};
...
\subsubsection{UC 1.3.11 - Modifica di un elemento SVG}{
	\label{uc1.3.11}
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.75]{\imgs {UC1.3.11}.jpg} %inserire il diagramma UML
		\label{fig:uc1.3.11}
		\caption{Caso d'uso 1.3.11: Modifica di un elemento SVG}
	\end{figure}
	\textbf{Attori}: utente desktop \\
	\textbf{Descrizione}: l'utente desktop può modificare dimensione e colore di un elemento SVG. \\
	\textbf{Precondizione}: il sistema ha una presentazione aperta in modalità modifica e l'utente desidera modificare un elemento SVG.	\\
	\textbf{Postcondizione}: l'elemento SVG è stato modificato come l'utente desiderava.	\\
	\textbf{Scenario principale}:
	\begin{enumerate}
		\item L'utente desktop può modificare le dimensioni di un elemento SVG \S\hyperref[uc1.3.11.1]{(UC 1.3.11.1)};
		\item L'utente desktop può modificare il colore di un elemento SVG \S\hyperref[uc1.3.11.2]{(UC 1.3.11.2)}.
	\end{enumerate}
	}
\subsubsection{UC 1.3.11.1 - Modifica dimensioni di un elemento SVG}{
	\label{uc1.3.11.1}
	\textbf{Attori}: utente desktop \\
	\textbf{Descrizione}: l'utente desktop può modificare le dimensioni di un elemento SVG. \\
	\textbf{Precondizione}: il sistema ha una presentazione aperta in modalità modifica e l'utente desidera modificare le dimensioni di un elemento SVG.	\\
	\textbf{Postcondizione}: le dimensioni dell'elemento SVG sono state modificate.	\\
	\textbf{Scenario principale}:
	\begin{enumerate}
		\item L'utente desktop seleziona un elemento SVG;
		\item L'utente desktop ridimensiona l'elemento SVG.
	\end{enumerate}
	}
\subsubsection{UC 1.3.11.2 - Modifica colore di un elemento SVG}{
	\label{uc1.3.11.2}
	\textbf{Attori}: utente desktop \\
...
\subsubsection{UC 1.3.12 - Eliminazione di un elemento SVG}{
	\label{uc1.3.12}
	\textbf{Attori}: utente desktop \\
	\textbf{Descrizione}: l'utente desktop elimina un elemento SVG dalla presentazione. \\
	\textbf{Precondizione}: il sistema ha una presentazione aperta in modalità modifica e l'utente desidera eliminare un elemento SVG.	\\
	\textbf{Postcondizione}: l'utente desktop ha eliminato un elemento SVG.	\\
	\textbf{Scenario principale}:
	\begin{enumerate}
		\item L'utente desktop seleziona un elemento SVG;
		\item L'utente desktop elimina l'elemento SVG selezionato.
	\end{enumerate}
	}