\subsection{UC 1.17 - Modifica infografica}{
	...
	\begin{enumerate}
		...
		\item Modifica e rimozione di un elemento grafico o di testo \hyperref[uc1.17.4]{(UC 1.17.4)};
...
\subsubsection{UC 1.17.4.1 - Modifica elemento infografica}{
	...
	\textbf{Scenario principale}:
	\begin{enumerate}
		\item Per un elemento grafico è possibile ingrandire o ridurre le dimensioni \hyperref[uc1.17.4.1.1]{(UC 1.17.4.1.1)};
