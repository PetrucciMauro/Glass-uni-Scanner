\subsection{UC 1.7 - Gestione archivio utente sul server}{
	...
	\begin{figure}[H]
		...
		\label{fig:uc1.7}
		\caption{Caso d'uso 1.7: Gestione dell'archivio dati utente sul server}
	\end{figure}
	...
	\textbf{Precondizione}: il programma è attivo e funzionante; l'utente ha effettuato il login e desidera effettuare modifiche ai propri file nel proprio account.	\\
	\textbf{Postcondizione}: l'utente ha eseguito l'operazione voluta sul contenuto che desiderava: ha inserito un nuovo file media nel proprio spazio, altrimenti ha rinominato una presentazione o una infografica oppure eliminato una presentazione, infografica o file media.	\\
	\textbf{Scenario principale}:
	\begin{enumerate}
		\item Inserimento file media \hyperref[uc1.7.1]{(UC 1.7.1)};
		\item Eliminazione file media \hyperref[uc1.7.2]{(UC 1.7.2)};
		\item Rinomina presentazione \hyperref[uc1.7.3]{(UC 1.7.3)};
		\item Rinomina infografica \hyperref[uc1.7.4]{(UC 1.7.4)};
		\item Eliminazione presentazioni \hyperref[uc1.7.5]{(UC 1.7.5)};
		\item Eliminazione infografica \hyperref[uc1.7.6]{(UC 1.7.6)}.
	\end{enumerate}
	}
\subsubsection{UC 1.7.1 - Inserimento file media}{
	...
	\subsubsection{UC 1.7.3 - Rinomina presentazione}{
		\label{uc1.7.3}
		\textbf{Attori}: utente autenticato.	\\
		\textbf{Descrizione}: l'utente ha la possibilità di rinominare una presentazione salvata nel proprio account. \\
		\textbf{Precondizione}: l'utente desidera rinominare una presentazione.	\\
	...
	\subsubsection{UC 1.7.4 - Rinomina infografica}{
		...
		\textbf{Precondizione}: l'utente desidera rinominare una infografica.	\\
	...
	\subsubsection{UC 1.7.6 - Eliminazione infografiche}{
		...
		\textbf{Precondizione}: l'utente desidera eliminare una o più infografiche.	\\
