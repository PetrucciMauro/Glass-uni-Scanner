	\subsection{View}{
		...
		\subsubsection{Premi::View::Pages::EditDesktop}{
			...
			\begin{itemize}
				\item EditDesktop::InsertFrame invia al controller la richiesta di inserimento di un nuovo frame e le coordinate di posizione e di rotazione;
				\item EditDesktop::InsertElement invia al controller la richiesta di inserimento di un nuovo elemento, le sue informazioni e le coordinate di posizione e di rotazione;
