...
%		\end{figure}
		...
		\subsubsection{View::Pages::EditMobile}{
			...
			\textbf{\relaz}: la classe EditMobile utilizza i metodi messi a disposizione dalla classe Presenter::Edit per caricare la presentazione da modificare, per l'inserimento di un elemento testuale, per la modifica di un elemento testuale, per l'inserimento di un nuovo bookmark, per rimuovere un bookmark.\\
