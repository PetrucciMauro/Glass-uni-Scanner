...
\subsubsection{Premi::Model::Caricamento}{
	...
	\subsubsubsection{Premi::Model::Caricamento::Uploader}{
       ...
       \subsubsubsection{Premi::Model::Caricamento::ConcreteSvgUploader}{
				\textbf{\tipo}: Classe che rappresenta un algoritmo di caricamento di un elemento svg all’interno dello spazio personale di un utente. È uno dei componenti concreti del Design Pattern Strategy.\\	
				\textbf{\relaz}: 
				\begin{itemize}
       ...
       \subsubsubsection{Premi::Model::Caricamento::ConcreteImageUploader}{
				\textbf{\tipo}: Classe che rappresenta un algoritmo di caricamento di un elemento immagine all’interno dello spazio personale di un utente. È uno dei componenti concreti del Design Pattern Strategy.\\	
				\textbf{\relaz}: 
				\begin{itemize}
