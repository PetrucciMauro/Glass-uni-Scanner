...
Premi::Model::Invoker -> esegue il comando o ne invoca il metodo di annullamento;
	...
	\subsubsubsection{Premi::Model::Presentazione::Loader}{
		...
		\begin{itemize}
            ...
            \item Premi::Model::SlideShow <- costruisce un oggetto di classe SlideShow ed eventualmente invoca le sue funzioni per inserire gli oggetti delle sottoclassi di SlideShowElement;
	...
	\subsubsubsection{Premi::Model::Presentazione::SlideShow}{
				...
				\textbf{\relaz}: 
				\begin{itemize}
                    \item Premi::Model::Presentazione::Loader -> invoca il costruttore di SlideShow.
				\end{itemize}	
 ...
 \subsubsection{Premi::Model::Builder}{
	...
	\subsubsubsection{Premi::Model::Builder::Director}{
				...
				\textbf{\relaz}: 
				\begin{itemize}
                    \item Premi::Model::Presentazione::Loader -> costruisce Director, passandogli i parametri per la costruizione degli offetti delle sottoclassi di Premi::Model::Presentazione::SlideShowElement e dell'oggetto Premi::Model::Presentazione::SlideShow.
