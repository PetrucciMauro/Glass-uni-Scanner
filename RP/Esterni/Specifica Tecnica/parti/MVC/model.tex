...
\subsubsection{Model::SlideShow::SlideShowActions}{
   ...
   \subsubsection{Model::SlideShow::SlideShowActions::Command}{
    ...
    \subsubsubsection{SlideShowElement}{
				...
				\end{itemize}	
                \textbf{\interfacce}:\\ Model::SlideShow::SlideShowActions::Insert::Inserter istanzia oggetti di sottoclassi di SlideShowElement e li inserisce nel campo dati contenitore presentazione all’interno di\\ Model::ServerRelations::Model:Costruttore\\
                \textbf{\figli}: 
                    \begin{itemize}
...
\subsubsection{Model::ServerRelations::Loader}{
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.4]{\imgs {serverrelationsloader}.pdf}
		\label{fig:srl}
...
\subsubsection{Model::ServerRelations::DbConsistency}{
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.4]{\imgs {ClassDiagram1}.pdf}
		\label{fig:cd}
