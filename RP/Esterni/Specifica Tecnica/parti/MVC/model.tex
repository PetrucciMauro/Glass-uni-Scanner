...
\subsubsection{Model::ApacheRelations::ApacheServerManager}{
	Il componente seguente appartiene al package ApacheServerManager, quindi lo scope sarà Model::ApacheRelations::ApacheServerManager::<componente>.
		...
		\end{itemize}
			...
			\subsubsection{Model::ApacheRelations::Manifest}{
				Il seguente componente appartiene al package Manifest, quindi lo scope sarà Model::ApacheRelations::Manifest::<componente>.
			   	\textbf{\tipo}: Questo package ha lo scopo di rendere disponibili le presentazioni in locale tramite chiamate ai servizi di nodeApi e ai metodi definiti in Model::ServerRelation::Loader. \\
			   	\textbf{\relaz}:
			   	\begin{itemize}
