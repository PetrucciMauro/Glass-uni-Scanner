	...
	\end{figure}
        ...
        \subsubsubsection{Autenticazione}{
				...
				\begin{itemize}
					...
					\item relazione da \textbf{Model::MongoRelations::BDSynch} a cui espone il token per poter usare i servizi di nodeApi
				\end{itemize}	
                    }
        \subsubsubsection{Registrazione}{
				\textbf{\tipo}: Classe, fornisce le unzionalità di registrazione.\\	
				\textbf{\relaz}: 
				\begin{itemize}
