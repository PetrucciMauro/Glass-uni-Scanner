...
\subsection{Premi::Model::SlideShow::SlideShowActions}{
	...
	Di seguito sono descritte le classi facenti parte del package Premi::Model::SlideShow::SlideShowActions::InsertEditRemove.
   ...
   \subsection{Premi::Model::SlideShow::SlideShowActions::Command}{
	...
	\subsubsection{Classi}{
	Di seguito sono descritte le classi facenti parte del package Premi::Model::SlideShow::SlideShowActions::Command.
    ...
    \subsubsubsection{ConcreteTextInsertCommand}{
     ...
     \subsubsubsection{ConcreteTextRemoveCommand}{
        ...
        \item Premi::Model::SlideShow::SlideShowActions::EditElements, i cui oggetti invocano metodi degli oggetti SlideShowElement che ne impostano i campi;
  		\end{itemize}
	\subsubsection{Classi}{
	Di seguito sono descritte le classi facenti parte del package Premi::Model::SlideShow::SlideShowElements.
