\section{Riunioni}
	...
	\subsection{Esterne}{
		Per le riunioni esterne (quindi gli incontri con il Proponente\ped{g}/Committente\ped{g}) la prassi \`{e} la medesima delle riunioni interne; pu\`{o} essere avanzata da qualsiasi membro del gruppo con il tag [Richiesta Riunione esterna $x$].
