...
\subsubsection{Progettazione}{
	Nella fase di  \textbf{Progettazione} ciascun componente rivestir\`{a} i seguenti ruoli:
	\begin{table}[H]
		\begin{tabular}{p{\dimexpr 0.22\linewidth-2\tabcolsep}p{\dimexpr 0.13\linewidth-2\tabcolsep}
									p{\dimexpr 0.13\linewidth-2\tabcolsep}p{\dimexpr 0.13\linewidth-2\tabcolsep}
									p{\dimexpr 0.13\linewidth-2\tabcolsep}p{\dimexpr 0.13\linewidth-2\tabcolsep}
...
\subsubsection{Progettazione in dettaglio e codifica}{
	Nella fase di \textbf{Progettazione in dettaglio e codifica} ciascun componente rivestir\`{a} i seguenti ruoli:
...
\subsubsection{Accettazione}{
	Nella fase di  \textbf{Accettazione} ciascun componente rivestir\`{a} i seguenti ruoli:
