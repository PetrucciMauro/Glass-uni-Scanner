...
\subsection{Analisi dei Requisiti}{
	...
	\begin{figure}[H]
		\includegraphics[scale=0.46]{\imgs pianoRequisiti.jpg}
...
\subsection{Progettazione}{
	...
	\begin{figure}[H]
		\includegraphics[scale=0.52]{\imgs pianoProgettazione.jpg}
	...
	\begin{figure}[H]
		\hspace{-2cm} \includegraphics[scale=0.30]{\imgs wbsProgettazione.jpg}
...
\subsection{Progettazione in dettaglio e Codifica}{
	...
	\begin{figure}[H]
		\hspace{-2cm} \includegraphics[scale=0.47]{\imgs pianoCodifica.jpg}
	...
	\begin{figure}[H]
		\hspace{-2cm} \includegraphics[scale=0.21]{\imgs wbsCodifica.jpg}
...
\subsection{Verifica e Validazione}{
	...
	\begin{figure}[H]
		\hspace{-2cm} \includegraphics[scale=0.34]{\imgs wbsAccettazione.jpg}
