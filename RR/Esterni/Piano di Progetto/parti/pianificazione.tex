...
\subsection{Analisi dei Requisiti}{
	...
	\begin{itemize}
		...
		\item \textbf{Studio di Fattibilità}: vengono valutati ...(?)... secondo quanto previsto nelle "Norme di Progetto" sezione "X".
		\item \textbf{Analisi dei Requisiti}: a partire dallo studio di fattibilità vengono analizzati in profondità i requisiti per il capitolato scelto con i metodi esplicitati in "Norme di Progetto" sezione "Y".
