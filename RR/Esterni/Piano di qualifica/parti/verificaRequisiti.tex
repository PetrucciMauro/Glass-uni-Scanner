...
\subsection{Verifica dei Requisiti\ped{g} Funzionali}{
	La seguente tabella descrive come abbiamo intenzione di verificare, tramite i test di sistema, i requisiti\ped{g} identificati durante l'attività di analisi.
	
		\renewcommand*{\arraystretch}{1.4}
		\begin{longtable} [c]{| p{3cm} | p{6cm} |p{3cm}|}
			\caption{Verifica dei Requisiti\ped{g} Funzionali \label{tab:verReqFunz}}\\
			 \hline
...
\newpage
\subsection{Verifica dei Requisiti\ped{g} di Qualità e Vincoli}{
		\renewcommand*{\arraystretch}{1.4}
		\begin{longtable} [c]{| p{7cm} |p{4cm}|}
			\caption{Verifica dei Requisiti\ped{g} di Qualità e Vincoli \label{tab:verReqQualVinc}}\\
			 \hline
