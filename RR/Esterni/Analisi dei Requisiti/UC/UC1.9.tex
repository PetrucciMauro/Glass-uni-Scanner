...
\subsubsection{UC1.9.1 - Caricamento di un template}{
	...
	\textbf{Procedura principale}:
	\begin{enumerate}
		\item l'amministratore naviga nel proprio spazio di lavoro  per trovare il template da inserire \hyperref[uc1.9.1.1]{(UC 1.9.1.1)};
...
\subsubsection{UC 1.9.1.1 - Navigazione nello spazio di lavoro}{
	\label{uc1.9.1.1}
	\textbf{Attori}: amministratore di sistema. \\
	\textbf{Descrizione}: l'amministratore può navigare nel proprio spazio di lavoro per selezionare la posizione da cui caricare il file. \\
...
\subsubsection{UC 1.9.1.2 - Selezione file}{
	\label{uc1.9.1.2}
	\textbf{Attori}: amministratore di sistema. \\
...
\subsubsection{UC 1.9.3 - Caricamento di un elemento}{
	...
	\textbf{Procedura principale}:
	\begin{enumerate}
		\item l'amministratore naviga nel proprio spazio di lavoro per trovare l'elemento grafico da inserire \hyperref[uc1.9.3.1]{(UC 1.9.3.1)};
...
\subsubsection{UC 1.9.3.1 - Navigazione nello spazio di lavoro}{
	\label{uc1.9.3.1}
	\textbf{Attori}: amministratore di sistema. \\
	\textbf{Descrizione}: l'amministratore può navigare nel proprio spazio di lavoro per selezionare la posizione da cui caricare il file. \\
	\textbf{Precondizione}: l'amministratore ha inizializzato l'attività di caricamento di un file.	\\
...
\subsubsection{UC 1.9.3.2 - Selezione file}{
	\label{uc1.9.3.2}
	\textbf{Attori}: amministratore di sistema. \\
	\textbf{Descrizione}: l'amministratore seleziona il file da caricare nel database. \\
	\textbf{Precondizione}: l'amministratore ha inizializzato l'attività di caricamento di un file.	\\
