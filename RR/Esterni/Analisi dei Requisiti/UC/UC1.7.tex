...
\subsection{UC 1.7.1 - Inserimento immagini}{
	...
	\subsection{UC 1.7.6 - Spostamento infografiche}{
		...
		\textbf{Procedura principale}:
		\begin{enumerate}
			\item navigazione nel FileSystem delle infografiche \hyperref[uc1.7.4.1]{(UC 1.7.4.1)};
			\item selezione cartella di lavoro \hyperref[uc1.7.4.2]{(UC 1.7.4.2)};
			\item selezione infografiche da spostare \hyperref[uc1.7.4.3]{(UC 1.7.4.3)};
			\item selezione cartella di destinazione \hyperref[uc1.7.4.4]{(UC 1.7.4.4)};
			\item conferma selezione e spostamento \hyperref[uc1.7.4.5]{(UC 1.7.4.5)}.
		\end{enumerate}
		\textbf{Scenari alternativi}: 
	...
	\subsection{UC 1.7.7 - Eliminazione infografiche}{
		...
		\textbf{Procedura principale}:
		\begin{enumerate}
			\item navigazione nel FileSystem delle infografiche \hyperref[uc1.7.5.1]{(UC 1.7.5.1)};
			\item selezione cartella di lavoro \hyperref[uc1.7.5.2]{(UC 1.7.5.2)};
			\item selezione infografiche da eliminare \hyperref[uc1.7.5.3]{(UC 1.7.5.3)};
			\item conferma selezione ed eliminazione \hyperref[uc1.7.5.4]{(UC 1.7.5.4)}.
		\end{enumerate}
		\textbf{Scenari alternativi}: 
		\begin{itemize}
