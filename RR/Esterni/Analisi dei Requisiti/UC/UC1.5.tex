\subsection{UC 1.5 - Esecuzione presentazione}{
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.75]{\imgs {UC1.5}.jpg} %inserire il diagramma UML
	\end{figure}
	...
	\begin{enumerate}
		\item scelta del metodo con cui eseguirla: automatica \hyperref[uc1.5.2]{(UC 1.5.2)} o manuale \hyperref[uc1.5.1]{(UC 1.5.1)};
		\item possibilità di passare da manuale ad automatico e viceversa \hyperref[uc1.5.3]{(UC 1.5.3)}  \hyperref[uc1.5.4]{(UC 1.5.4)}.
	\end{enumerate}
	}
\subsection{UC 1.5.1 - Esecuzione manuale}{
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.75]{\imgs {UC1.5.1}.jpg} %inserire il diagramma UML
		\end{figure}
		\textbf{Attori}: utente generico \\
		...
		\begin{enumerate}
			\item l'utente scorre la presentazione \hyperref[uc1.5.1.1]{(UC 1.5.1.1)};
			\item l'utente può scegliere il percorso su cui continuare \hyperref[uc1.5.1.2]{(UC 1.5.1.2)};
			\item l'utente può saltare al bookmark successivo \hyperref[uc1.5.1.3]{(UC 1.5.1.3)};
			\item l'utente può cambiare il livello di visualizzazione \hyperref[uc1.5.1.4]{(UC 1.5.1.4)};
			\item l'utente può ingrandire il contenuto \hyperref[uc1.5.1.5]{(UC 1.5.1.5)};
			\item l'utente può riprodurre file media \hyperref[uc1.5.1.6]{(UC 1.5.1.6)};
			\item l'utente può avviare la presentazione automatica da qualsiasi frame \hyperref[uc1.5.3]{(UC 1.5.3)}.
		\end{enumerate}
		}
	...
	\subsection{UC 1.5.1.6 - Riproduzione media}{
		\label{uc1.5.1.6}
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.75]{\imgs {UC1.5.1.6}.jpg} %inserire il diagramma UML
		\end{figure}
		\textbf{Attori}: utente generico \\
		...
		\textbf{Scenario principale}:
		\begin{enumerate}
			\item l'utente può avviare la riproduzione di un media, dall'inizio \hyperref[uc1.5.1.6.1]{(UC 1.5.1.6.1)} o da un punto specifico  \hyperref[uc1.5.1.6.4]{(UC 1.5.1.6.4)};
			\item l'utente può mettere in pausa la riproduzione del media \hyperref[uc1.5.1.6.2]{(UC 1.5.1.6.2)} e riprenderla successivamente  \hyperref[uc1.5.1.6.3]{(UC 1.5.1.6.3)};
			\item l'utente può arrestare la presentazione \hyperref[uc1.5.1.6.5]{(UC 1.5.1.6.5)}.
		\end{enumerate}
	}
...
\subsection{UC 1.5.2 - Esecuzione automatica}{
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.75]{\imgs {UC1.5.2}.jpg} %inserire il diagramma UML
	\end{figure}
	\textbf{Attori}: utente generico \\
	...
	\textbf{Scenario principale}:
	\begin{enumerate}
		\item l'utente avvia la presentazione \hyperref[uc1.5.2.1]{(UC 1.5.2.1)};
		\item l'utente mette in pausa la presentazione \hyperref[uc1.5.2.4]{(UC 1.5.2.4)}  e riprenderla successivamente  \hyperref[uc1.5.2.2]{(UC 1.5.2.2)};
		\item l'utente arresta la presentazione \hyperref[uc1.5.2.3]{(UC 1.5.2.3)};
		\item l'utente può decidere il tempo di scorrimento frame \hyperref[uc1.5.2.5]{(UC 1.5.2.5)};
		\item l'utente può gestire i file media \hyperref[uc1.5.2.6]{(UC 1.5.2.6)};
		\item l'utente decide di passare alla modalità manuale \hyperref[uc1.5.4]{(UC 1.5.4)}.
	\end{enumerate}
	}
	...
	\subsection{UC 1.5.2.6 - Gestione media}{
		...
		\begin{figure}
			\centering
			\includegraphics[scale=0.75]{\imgs {UC1.5.2.6}.jpg} %inserire il diagramma UML
		\end{figure}
		\textbf{Attori}: utente generico \\
		...
		\textbf{Scenario principale}:
		\begin{enumerate}
			\item la presentazione automatica avvia la riproduzione del media \hyperref[uc1.5.2.6.1]{(UC 1.5.2.6.1)};
			\item l'utente può saltare la riproduzione del media \hyperref[uc1.5.2.6.5]{(UC 1.5.2.6.5)};
			\item l'utente può mettere in pausa la riproduzione del media \hyperref[uc1.5.2.6.2]{(UC 1.5.2.6.2)} e riprenderla dallo stesso punto \hyperref[uc1.5.2.6.3]{(UC 1.5.2.6.3)} o da punti diversi \hyperref[uc1.5.2.6.4]{(UC 1.5.2.6.4)};
			\item l'utente ha la possibilità di ingrandire un video \hyperref[uc1.5.2.6.6]{(UC 1.5.2.6.6)}.
		\end{enumerate}
	}
