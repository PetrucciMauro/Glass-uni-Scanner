...
\subsubsection{UC 1.17.4 - Modifica di un oggetto dell'infografica}{
	\label{uc1.17.4}
	\begin{figure}[H]
		\centering
...
\subsubsection{UC 1.17.4.1 - Modifica dimensioni di un oggetto grafico}{
	\label{uc1.17.4.1}
	\textbf{Attori}: utente desktop, amministratore di sistema. \\
...
\subsubsection{UC 1.17.4.2 - Modifica di elemento testuale}{
	\label{uc1.17.4.2}
	\begin{figure}[H]
		\centering
...
\subsubsection{UC 1.17.4.2.1 - Modifica del carattere}{
	\label{uc1.17.4.2.1}
	\textbf{Attori}: utente desktop, amministratore di sistema. \\
...
\subsubsection{UC 1.17.4.2.5 - Modifica sfondo}{
	\label{uc1.17.4.2.5}
	\textbf{Attori}: utente desktop, amministratore di sistema. \\
...
\subsubsection{UC 1.17.7 - Inserimento di un elemento grafico}{
	\label{uc1.17.7}
	\textbf{Attori}: utente desktop, amministratore di sistema. \\
...
\subsubsection{UC 1.17.10 - Salvataggio infografica}{
	\label{uc1.17.10}
	\textbf{Attori}: utente desktop, amministratore di sistema. \\
