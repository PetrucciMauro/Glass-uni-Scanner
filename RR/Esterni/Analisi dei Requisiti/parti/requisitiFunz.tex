\subsection{Requisiti Funzionali}{
		...
		%MODIFICA DESKTOP
			...
			\hline
			RF 7.1.13 & Obbligatorio & L'utente deve essere in grado di inserire una immagine di sfondo in un’area nel piano di una presentazione & UC 1.3.1.5, 1.3.1.5.1, 1.3.1.5.1.1, 1.3.1.5.1.3, 1.3.1.5.1.4\\
			\hline
			RF 7.1.16 & Obbligatorio & L'utente deve essere in grado di inserire un colore di sfondo in un’area nel piano di una presentazione & UC 1.3.1.5, 1.3.1.5.1, 1.3.1.5.1.2, 1.3.1.5.1.3, 1.3.1.5.1.4\\
			\hline
			RF 7.1.19 & Obbligatorio & L'utente deve essere in grado di definire i percorsi di visualizzazione di una presentazione & UC 1.3.1.6\\
			\hline
			RF 7.1.19.1 & Obbligatorio & L'utente deve essere in grado di impostare un frame iniziale per il percorso principale di una presentazione & UC 1.3.1.6.1\\
			\hline
			RF 7.1.19.4 & Obbligatorio & L’utente deve essere in grado di definire una nuova transizione tra due frame di una presentazione & UC 1.3.1.6.2\\
			\hline
			RF 7.1.19.7 & Obbligatorio & L'utente deve essere in grado di definire una transizione scelta tra due frame di una presentazione & UC 1.3.1.6.5\\
			\hline
			RF 7.1.19.10 & Obbligatorio & L'utente deve essere in grado di eliminare una transizione tra due frame di una presentazione & UC 1.3.1.6.4\\
			\hline
			RF 7.1.19.13 & Obbligatorio & L'utente deve essere in grado di togliere un frame dal percorso di una presentazione & UC 1.3.1.6.3\\
			\hline
			RF 7.1.22 & Obbligatorio & L'utente deve essere in grado di impostare un bookmark ad un frame di una presentazione & UC 1.3.1.7, 1.3.1.7.1\\
			\hline
			RF 7.1.25 & Obbligatorio & L'utente deve essere in grado di eliminare un bookmark ad un frame di una presentazione & UC 1.3.1.7, 1.3.1.7.2\\
			\hline
			RF 7.1.28 & Desiderabile & L'utente può impostare la velocità di transizione tra frame consecutivi di un percorso di una presentazione & UC 1.3.1.8\\
			\hline
			RF 7.1.31 & Obbligatorio & L'utente può impostare l’effetto di transizione tra due frame consecutivi di un percorso di una presentazione & UC 1.3.1.8\\
			\hline
			RF 7.1.34 & Obbligatorio & L'utente può impostare il tempo di attesa tra due transizioni consecutive per la modalità "esecuzione automatica" & UC 1.3.1.9\\
		%MODIFICA MOBILE				
			\hline
			...
			\hline
			RF 61.1.10 & Obbligatorio & L'utente deve essere in grado di tornare al frame contenitore del frame attualmente visualizzato & UC 1.18.1.4\\
			\hline
			RF 61.1.13 & Obbligatorio & L'utente deve essere in grado di effettuare uno zoom in una parte del frame & UC 1.18.1.5\\
			\hline
			RF 61.1.16 & Obbligatorio & L'utente deve essere in grado di visualizzare dei video all'interno della presentazione & UC 1.18.1.6\\
			\hline
			RF 61.1.16.1 & Obbligatorio & L'utente deve essere in grado di far partire l'esecuzione del video & UC 1.18.1.6.1\\
			\hline
			RF 61.1.16.4 & Obbligatorio & L'utente deve essere in grado di sospendere e riprendere l'esecuzione del video & UC 1.18.1.6.2, 1.18.1.6.3\\
			\hline
			RF 61.1.16.7 & Obbligatorio & L'utente deve essere in grado di visualizzare l'esecuzione del video da un punto qualsiasi dello stesso & UC 1.18.1.6.4\\
			\hline
			RF 61.1.16.10 & Obbligatorio & L'utente deve essere in grado di  interrompere l'esecuzione del video & UC 1.18.1.6.5\\
			\hline
			...
			\hline
			RF 61.4.4 & Desiderabile & L'utente deve essere in grado di sospendere e riavviare una presentazione in esecuzione automatica & UC 1.18.2.3, 1.18.2.4\\
			\hline
			...
			\hline
			RF 61.4.10 & Desiderabile & L'utente deve essere in grado di saltare la visualizzazione di un video presente nel frame visualizzato & UC 1.18.2.6\\			
			\hline
			...
			\hline
			RF 70.4.1.2 & Opzionale & L'utente deve essere in grado di apportare modifiche a un oggetto testuale dell'infografica & UC 1.17.4.1.2\\
			\hline
			RF 70.4.1.2.1 & Opzionale & L'utente deve essere in grado di modificare i caratteri (font) dell'elemento testuale & UC 1.17.4.1.2.1\\
			\hline
			RF70.4.1.2.2  & Opzionale & L'utente deve essere in grado di modificare la dimensione dei caratteri dell'elemento testuale & UC 1.17.4.1.2.2\\
			\hline
			RF 70.4.1.2.3 & Opzionale & L'utente deve essere in grado di cambiare la formattazione di un elemento testuale (corsivo, grassetto, sottolineato) & UC 1.17.4.1.2.3\\
			\hline
			RF 70.4.1.2.5 & Opzionale & L'utente deve essere in grado di cambiare il colore dello sfondo della scritta dell'elemento testuale (evidenziazione) & UC 1.17.4.1.2.5\\
			\hline
			RF 70.4.1.3 & Opzionale & L'utente deve essere in grado di cambiare la posizione dell'oggetto & UC 1.17.4.1.3\\
			\hline
			RF 70.4.2 & Opzionale & L'utente deve essere in grado di rimuovere lo sfondo dell'infografica & UC 1.17.4.2\\
			\hline
			RF 70.4.3 & Opzionale & L'utente deve essere in grado di inserire uno sfondo nell'infografica & UC 1.17.4.3\\
			\hline
			RF 70.4.4 & Opzionale & L'utente deve essere in grado di inserire un elemento grafico nell'infografica & UC 1.17.4.4\\
			\hline
			RF 70.4.5 & Opzionale & L'utente deve essere in grado di inserire un elemento testuale nell'infografica & UC 1.17.4.5\\
			\hline
			RF 70.4.6 & Opzionale & L'utente deve essere in grado di inserire un frame nella sua interezza all'interno dell'infografica & UC 1.17.4.6\\
			\hline
			RF 70.4.7 & Opzionale & L'utente deve essere in grado di eliminare un elemento grafico o testuale all'interno dell'infografica & UC 1.17.4.7\\
			\hline
			RF 70.5 & Opzionale & L'utente deve essere in grado di salvare l'infografica nel suo spazio & UC 1.17.5\\
			\hline
			RF 70.6 & Opzionale & L'utente deve essere in grado di annullare una modifica appena effettuata all'infografica o di ripristinarla & UC 1.17.6\\
			\hline
			RF 70.7 & Opzionale & L'utente deve essere in grado di esportare un'infografica in formato stampabile & UC 1.17.7\\
			\hline
