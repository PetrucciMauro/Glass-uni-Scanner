...
L'utente potrà definire più percorsi di presentazione con la possibilità di avere più di una visualizzazione possibile per una certa presentazione, il percorso di slide che sarà visualizzato sarà scelto dal presentatore in fase di visualizzazione(g).
...
\item creare una nuova presentazione da dispositivo desktop(g)
\item modificare una presentazione da dispositivio desktop(g)
\item modificare parzialmente la presentazione da dispositivo mobile(g)
