...
\end{itemize}
	...
	\subsubsection{Installazione su sistemi Microsoft Windows}{
		\begin{enumerate}
			\item Copiare la cartella \texttt{/source/MyTalk} nella cartella\\ \path{/source/apache-tomcat/apache-tomcat-7.0.37-WIN{architettura}/webapps} dove \{architettura\} può essere 32 oppure 64 a seconda della versione del sistema operativo;
