...
\newpage	
	...
	\end{figure}
	Si può infine notare dalla figura \ref{fig: torta} che nonostante le 25 ore in meno i due ruoli a progetto che assumono maggiore importanza sono quelli del Verificatore e del Progettista. Entrambi sottolineano la qualità e la funzionalità del prodotto; i Progettisti pongono le basi a priori mentre i Verificatori la accertano a posteriori.
