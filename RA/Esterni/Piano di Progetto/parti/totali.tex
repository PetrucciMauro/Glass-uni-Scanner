...
\subsection{totale ore e costi rendicontabili effettivi}
			...
			\begin{table}[H] %TABELLA RUOLI
			\centering
				\begin{tabular}{|p{\dimexpr 0.18\linewidth-0.3\tabcolsep}|p{\dimexpr 0.10\linewidth-0.1\tabcolsep}
													p{\dimexpr 0.11\linewidth-0.4\tabcolsep}p{\dimexpr 0.11\linewidth-0.4\tabcolsep}
													p{\dimexpr 0.11\linewidth-0.4\tabcolsep}p{\dimexpr 0.11\linewidth-0.4\tabcolsep}
													p{\dimexpr 0.10\linewidth-0.4\tabcolsep} || p{\dimexpr 0.11\linewidth-0.4\tabcolsep}|}
				 		\hline
			 & \TP & \VG & \FM & \BM & \PM & \GP& \textbf{Totali} \\
			 \hline
