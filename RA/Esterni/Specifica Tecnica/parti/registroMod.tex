...
\begin{longtable} [c]{|>{\centering\arraybackslash}m{2cm} | >{\centering\arraybackslash}m{4cm} | >{\centering\arraybackslash}m{3cm} | >{\centering\arraybackslash}m{6cm} |}
		...
		\endhead
		 ...
		 \hline
		 \endlastfoot
		 4.0.0 & \FM & 09-09-2015 & Approvazione del documento \\
		 \hline
 		 ...
 		 \hline
		 3.0.0 & \BM & 09-09-2015 & Aggiornati diagrammi di sequenza, CommandPackage; aggiunta appendice: Pattern \\
 		 \hline
		 3.0.0 & \VG & 09-09-2015 & Rimossa sezione SVG \\
		 \hline
		 3.0.0 & \VG & 08-09-2015 & Aggiornato Invoker, abstractCommand \\
		 \hline
		 3.0.0 & \TP & 08-09-2015 & Divisione server/MVC; aggiornato NodeServer; aggiornati diagrammi backEnd \\
		 \hline
