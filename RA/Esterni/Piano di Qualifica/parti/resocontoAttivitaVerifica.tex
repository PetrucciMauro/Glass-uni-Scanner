...
Vengono qui riportati i valori dell’indice Gulpease per ogni documento durante la fase di \textbf{Validazione}. Un documento è considerato valido soltanto se rispetta le metriche\ped{g} descritte su \S\ref{sec:metricadocumenti}.
...
\end{itemize}
\end{itemize}
I valori del Back-end sono sufficienti mentre il Front-end non arriva per poco alla sufficienza.
\\\\
