...
\begin{longtable} [c]{|>{\centering\arraybackslash}m{2cm} | >{\centering\arraybackslash}m{4cm} | >{\centering\arraybackslash}m{3cm} | >{\centering\arraybackslash}m{6cm} |}
		...
		\endhead
         ...
         \hline
         3.4.0 & \PM & 09-09-2015 & Verifica del documento\\
         \hline
		 3.3.0 & \GP & 08-09-2015 & Modificati test di unità, aggiunta tabella Gulpease\\
  		 \hline
 		 3.2.0 & \PM & 07-09-2015 & Inserimento metriche per la Validazione\\
		 \hline 
		 3.1.0 & \PM & 07-09-2015 & Apportate correzioni a seguito delle segnalazioni del committente\\
		 \hline 
