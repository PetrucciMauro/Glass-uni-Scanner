...
\subsection{Test d'unità}
 ...
 \begin{longtable} [c]{| p{1cm} | p{6cm} |p{8cm} | p{1.5cm} |}
 		 ...
 		 TU48 & viene chiamato il metodo del Server\ped{g} per l'inserimento di un Elemento\ped{g} in una presentazione, viene verificato l'inserimento dell'Elemento\ped{g} in database & newElement( presentation:string , obj:object , callback:function ) & success \\
 		 TU49 & viene inserito un Elemento\ped{g} in una presentazione in database, viene chiamato il metodo con i parametri corretti e si osserva la modifica dell'Elemento\ped{g} dalla presentazione & updateElement(presentation  :string , obj : object , callback : function) & success \\
