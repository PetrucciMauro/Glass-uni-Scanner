...
\subsection{Risorse}{
Per assicurare che gli obiettivi qualitativi vengano raggiunti è necessario l’utilizzo di Risorse\ped{g} sia umane che tecnologiche. Per una dettagliata descrizione dei ruoli e delle loro responsabilità fare riferimento alle Norme di Progetto\ped{g}. Per Risorse\ped{g} tecniche e tecnologiche sono da intendersi tutti gli strumenti Software\ped{g} e hardware che il gruppo intende utilizzare per attuare le attività di verifica su Processi\ped{g} e prodotti. Affinché il lavoro dei Verificatori venga agevolato si sono predisposti numerosi strumenti automatici che eseguono controlli sistematici sui prodotti generati. Tali strumenti sono descritti in modo accurato nelle Norme di Progetto\ped{g}.
}