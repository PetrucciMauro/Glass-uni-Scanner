...
\begin{longtable} [c]{|>{\centering\arraybackslash}m{2cm} | >{\centering\arraybackslash}m{4cm} | >{\centering\arraybackslash}m{3cm} | >{\centering\arraybackslash}m{6cm} |}
		...
		\endhead
		 ...
		 \hline
		 \endlastfoot
		 4.0.0 & \FM & 09-08-2015 & Approvazione del documento\\
		 \hline 
		 3.3.0 & \PM & 08-08-2015 & Verifica del documento\\
		 \hline 
		 3.2.0 & \GP & 07-08-2015 & Apportate le correzioni sul documento a seguito delle segnalazioni del committente\\
		 \hline 
		 3.1.0 & \GP & 07-08-2015 & Corretto use Case 9.2\\
		 \hline 
