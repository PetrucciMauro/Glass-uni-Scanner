\subsection{UC 1.10 - Annulla/Ripristina presentazione desktop}{
	...
	\begin{figure}[H]
		...
		\label{fig:uc1.10}
		\caption{Caso d'uso 1.10: Annulla/Ripristina presentazione desktop}
	\end{figure}
	...
	\textbf{Precondizione}:  l'utente ha effettuato l'accesso al sistema in modalità modifica ad una presentazione in modalità Desktop\ped{g} \\
