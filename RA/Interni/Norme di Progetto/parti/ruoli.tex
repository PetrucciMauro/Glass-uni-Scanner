...
Si descrivono ora i diversi ruoli di Progetto\ped{g}, con le relative responsabilità e le modalità operative affinché essi possano svolgere i compiti assegnati con l'ausilio dei Software\ped{g} scelti per il Progetto\ped{g}.
\subsection{Responsabile di Progetto}
Il \textit{Responsabile di Progetto} rappresenta il Progetto\ped{g}, in quanto accentra su di sé le responsabilità di scelta ed approvazione, ed il gruppo, in quanto presenta al Committente\ped{g} i risultati del lavoro svolto.
Detiene il potere decisionale, quindi la responsabilità su:
\begin{itemize}
\item Pianificazione, coordinamento e controllo delle attività;
\item Gestione e controllo delle Risorse\ped{g};
...
Ha inoltre l'incarico di gestire la creazione e l'assegnazione dei Ticket\ped{g} delle macro-fasi e di assegnare ad un membro del gruppo il ruolo di responsabile di quest’ultima.
...
\item Risoluzione dei problemi legati alle difficoltà di gestione e controllo dei Processi\ped{g} e delle Risorse\ped{g}. La risoluzione di tali problemi richiede l'adozione di strumenti adatti;
\item Controllo delle versioni e delle configurazioni del prodotto;
\item Gestione dell'archiviazione e del versionamento della documentazione di Progetto\ped{g};
...
\begin{itemize}
\item Produrre una specifica di Progetto\ped{g} comprensibile, sia per il Proponente\ped{g}, sia per il
Committente\ped{g} che per il \textit{Progettista}, e motivata in ogni suo punto;
...
Partecipa alla redazione del \textit{Piano di Qualifica} in quanto conosce l’ambito del Progetto\ped{g} ed ha chiari i livelli di qualità richiesta e le procedure da applicare per ottenerla.
...
\end{itemize}
Redige la \textit{Specifica Tecnica}, la \textit{Definizione di Prodotto} e le sezioni inerenti le metriche\ped{g} di verifica della programmazione del \textit{Piano di Qualifica}.
...
\item Controllare la conformità di ogni stadio del ciclo di vita\ped{g} del prodotto.
\end{itemize}
...
Il \textit{Programmatore} è responsabile delle attività di Codifica\ped{g} e delle componenti di ausilio necessarie per l'esecuzione delle prove di verifica e Validazione\ped{g}. Le responsabilità di tale
ruolo sono:
\begin{itemize}
...
\item Scrivere Codice\ped{g} documentato, versionato, manutenibile e che rispetti gli standard stabiliti per la scrittura del Codice\ped{g};
\item Implementare i test sul Codice\ped{g} scritto, necessari per prove di verifica e Validazione\ped{g}.
Redige il \textit{Manuale Utente} e produce un'adeguata documentazione del Codice\ped{g}.
\end{itemize}