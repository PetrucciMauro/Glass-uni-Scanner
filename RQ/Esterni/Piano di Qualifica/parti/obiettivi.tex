...
\textbf{Quantificazione del raggiungimento dell’obbiettivo di qualità:} Per la misurazione di questo requisito si fa riferimento alle metriche\ped{g} descritte nella sezione \ref{sec:metriche}.
