...
Questo documento è rivolto all’amministratore, ha lo scopo di illustrare le procedure da seguire per svolgere le operazioni di amministratore di \premi . All’utilizzatore non è richiesta alcuna conoscenza informatica poiché dovrà interfacciarsi, tramite WEB\ped{g} Browser\ped{g}, alle funzionalità di \premi che vengono erogate con le stesse modalità di un normale sito internet.
...
L’utente deve possedere una connessione ad internet e un WEB\ped{g} Browser\ped{g}.
