...
\subsubsection{UC 1.18.1 - Esecuzione manuale}{
		...
		\begin{enumerate}
			...
			\item L'utente può scegliere il percorso su cui continuare \S\hyperref[uc1.18.1.2]{(UC 1.18.1.2)};
			\item L'utente può saltare al bookmark successivo \S\hyperref[uc1.18.1.3]{(UC 1.18.1.3)};
			...
			\item L'utente può riprodurre file media \S\hyperref[uc1.18.1.6]{(UC 1.18.1.6)}.
		\end{enumerate}
		\textbf{Scenario alternativo}: 
		\begin{itemize}
			\item L'utente può avviare la presentazione automatica da qualsiasi frame \S\hyperref[uc1.18.3]{(UC 1.18.3)}.
		\end{itemize}
		}
	...
	\subsubsection{UC 1.18.1.6 - Riproduzione file media audio/video}{
		...
		\textbf{Scenario principale}:
		\begin{enumerate}
			\item L'utente può avviare la riproduzione di un file media, dall'inizio \S\hyperref[uc1.18.1.6.1]{(UC 1.18.1.6.1)} o da un punto specifico  \S\hyperref[uc1.18.1.6.4]{(UC 1.18.1.6.4)};
			\item L'utente può mettere in pausa la riproduzione del file media \S\hyperref[uc1.18.1.6.2]{(UC 1.18.1.6.2)} e riprenderla successivamente  \S\hyperref[uc1.18.1.6.3]{(UC 1.18.1.6.3)};
			\item L'utente può arrestare la riproduzione del file media \S\hyperref[uc1.18.1.6.5]{(UC 1.18.1.6.5)}.
		\end{enumerate}
	}
...
\subsubsection{UC 1.18.2 - Esecuzione automatica}{
	...
	\begin{enumerate}
		...
		\item L'utente può decidere il tempo di durata presentazione dei frame \S\hyperref[uc1.18.2.5]{(UC 1.18.2.5)};
		\item L'utente può gestire i file media durante l'esecuzione \S\hyperref[uc1.18.2.6]{(UC 1.18.2.6)}.
	\end{enumerate}
	\textbf{Scenario alternativo}: 
	\begin{itemize}
	...
	\subsubsection{UC 1.18.2.6 - Riproduzione file media audio/video}{
		...
		\textbf{Scenario principale}:
		\begin{enumerate}
			\item La presentazione automatica avvia la riproduzione del file media \S\hyperref[uc1.18.2.6.1]{(UC 1.18.2.6.1)};
			\item L'utente può saltare la riproduzione del file media \S\hyperref[uc1.18.2.6.5]{(UC 1.18.2.6.5)};
			\item L'utente può mettere in pausa la riproduzione del file media \S\hyperref[uc1.18.2.6.2]{(UC 1.18.2.6.2)} e riprenderla dal punto in cui l'aveva sospesa \S\hyperref[uc1.18.2.6.3]{(UC 1.18.2.6.3)} o da punti diversi \S\hyperref[uc1.18.2.6.4]{(UC 1.18.2.6.4)};
