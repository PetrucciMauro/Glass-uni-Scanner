...
\subsubsection{UC 1.18.1 - Esecuzione manuale}{
	...
	\subsubsection{UC 1.18.1.3 - Salto al Bookmark\ped{g} successivo}{
		\label{uc1.18.1.3}
		\textbf{Attori}: utente. \\
	...
	\subsubsection{UC 1.18.1.6 - Riproduzione File\ped{g} media audio/video}{
		\label{uc1.18.1.6}
		\begin{figure}[H]
			\centering
	...
	\subsubsection{UC 1.18.1.6.1 - Avvio manuale della riproduzione di un File\ped{g} media}{
		\label{uc1.18.1.6.1}
		\textbf{Attori}: utente. \\
	...
	\subsubsection{UC 1.18.1.6.2 - Sospensione della riproduzione del File\ped{g} media}{
		\label{uc1.18.1.6.2}
		\textbf{Attori}: utente. \\
	...
	\subsubsection{UC 1.18.1.6.3 - Ripresa dell'esecuzione del File\ped{g} media}{
		\label{uc1.18.1.6.3}
		\textbf{Attori}: utente. \\
	...
	\subsubsection{UC 1.18.1.6.4 - Riproduzione del File\ped{g} media da qualsiasi minuto}{
		\label{uc1.18.1.6.4}
		\textbf{Attori}: utente. \\
...
\subsubsection{UC 1.18.2 - Esecuzione automatica}{
	...
	\subsubsection{UC 1.18.2.5 - Imposta tempo scorrimento frame}{
		...
		\end{enumerate}		}
	\subsubsection{UC 1.18.2.6 - Riproduzione File\ped{g} media audio/video}{
		\label{uc1.18.2.6}
		\begin{figure}
			\centering
	...
	\subsubsection{UC 1.18.2.6.1 - Avvio automatico riproduzione di un File\ped{g} media}{
		\label{uc1.18.2.6.1}
		\textbf{Attori}: utente. \\
	...
	\subsubsection{UC 1.18.2.6.2 - Sospensione della riproduzione del File\ped{g} media}{
		\label{uc1.18.2.6.2}
		\textbf{Attori}: utente. \\
	...
	\subsubsection{UC 1.18.2.6.3 - Ripresa dell'esecuzione del File\ped{g} media}{
		\label{uc1.18.2.6.3}
		\textbf{Attori}: utente. \\
	...
	\subsubsection{UC 1.18.2.6.4 - Riproduzione del File\ped{g} media da qualsiasi minuto}{
		\label{uc1.18.2.6.4}
		\textbf{Attori}: utente. \\
