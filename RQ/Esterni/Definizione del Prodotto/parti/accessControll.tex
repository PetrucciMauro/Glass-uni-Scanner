	...
	\end{figure}
		\textbf{Attributi:}
			...
			\item \textbf{-messageState}
				...
				\item \textbf{Descrizione:} messaggio ritornato dall'ultima chiamata di autenticazione al server
				\end{itemize}
			\end{itemize}
	...
	\textbf{Attributi:}
			...
			\item \textbf{-token}
				...
				\item \textbf{Accesso:} private
				\item \textbf{Tipo:} string
				\item \textbf{Descrizione:} stringa per l?autenticazione ai servizi Server nodeJs
		...
		\item \textbf{authenticate(user : string, password : string) : bool}
			\begin{itemize}
			\item \textbf{Accessibilit\`{a}:} public
			\item \textbf{Descrizione:} chiama il servizio account/authenticate, ritorna true se la chiamata \`{e} andata a buon fine, in questo caso mette nel campo token il token ritornato dal server nodeJs
