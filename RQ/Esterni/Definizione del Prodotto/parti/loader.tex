	...
	\end{figure}
		\textbf{Attributi:}
			...
			\item \textbf{- toInsert}
				...
				\item \textbf{Descrizione:} array di identificativi di elementi inseriti in locale dall'ultima sincronizzazione verso MongoDB
				\end{itemize}
			\item \textbf{- toUpdate}
				\begin{itemize}
				\item \textbf{Accesso:} private
				\item \textbf{Tipo:} object
				\item \textbf{Descrizione:} array di identificativi di elementi modificati in locale dall'ultima sincronizzazione verso MongoDB
				\end{itemize}
			\item \textbf{- toDelete}
				\begin{itemize}
				\item \textbf{Accesso:} private
				\item \textbf{Tipo:} object
				\item \textbf{Descrizione:} array di identificativi di elementi eliminati in locale dall'ultima sincronizzazione verso MongoDB
				\end{itemize}
			\item \textbf{- toPaths}
				\begin{itemize}
				\item \textbf{Accesso:} private
