\section{Package Premi::\-Controller}{
	...
	\subsection {Controller::\-Services}{
		\label{sec:services}
		\textbf{\tipo}: i servizi sono degli oggetti che incapsulano del Codice\ped{g} che si occupa di eseguire uno specifico compito, il quale sarà poi utilizzato all’interno di una o più parti dell’applicazione.\\
		\textbf{\relaz}: comunica con il controller per la gestione delle funzioni\ped{g} da eseguire e con il model per la gestione delle componenti necessarie.
