\subsection{Controller}{
	...
	\subsubsection{Controller::\-Services}{
		...
		\end{itemize}
		\textbf{\interfacce}: SharedData richiama il metodo corretto di mongoRelation in modo da inviare una richiesta http al server per ottenere la presentazione voluta.
		}
