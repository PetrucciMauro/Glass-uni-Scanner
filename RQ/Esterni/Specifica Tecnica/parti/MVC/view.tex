	\subsection{View}{
		...
		\subsubsection{View::ViewJavascript::UserFunctions}{
			...
			\textbf{\relaz}: comunica con il Controller per tutte le chiamate JavaScript effettuate dall'utente.\\
