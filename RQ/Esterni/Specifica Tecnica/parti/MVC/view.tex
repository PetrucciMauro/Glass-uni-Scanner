	\subsection{View}{
		...
		\textbf{\relaz}: il componente è costituito dal package Pages e comunica con il Presenter per rendere possibile la gestione del proprio profilo, la gestione delle presentazioni e per controllare i dati in transito per il sistema, dovuti all'interazione dell'utente con lo stesso e la comunicazione con il Presenter.\\
		...
		\subsubsection{View::Pages::IndexPage}{
			\textbf{\tipo}: la classe IndexPage definisce la struttura, e la conseguente visualizzazione, della pagina web che consente ad un utente di effettuare login e registrazione al sistema.\\
