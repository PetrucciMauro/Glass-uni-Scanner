...
L'editor\ped{g} permette di inserire i frame\ped{g} che compongono la presentazione in un'area apposita; all'interno dei frame possono essere inseriti anche elementi multimediali. Per procedere alla creazione della slide è sufficiente:
\begin{itemize}
